...
use crate::proxy_helpers::{content_type_allowed, is_hop_header_fast};
use crate::proxy_logging::push_log_lazy;
use crate::proxy_matching::match_route;
use crate::proxy_request::prepare_proxy_request;
...
pub(crate) async fn proxy_handler(
    ...
    let crate::proxy_request::PreparedProxyRequest {
        target,
        req_body_size,
...
mod tests {
    ...
    use crate::proxy_matching::{host_matches, normalize_host};
