...
use crate::proxy_context::{enqueue_request_log, format_access_log, RequestContext};
use crate::proxy_helpers::{cached_regex, content_type_allowed, expand_proxy_header_value, is_hop_header_fast};
...
pub async fn prepare_proxy_request(
    ...
    let mut upstream_url = crate::proxy_upstream::pick_upstream_smooth(route)
