...
.light-mode .reset-terms-btn {
  ...
  box-shadow: 0 4px 12px rgba(209, 138, 22, 0.22) !important;
}

.light-mode .reset-terms-btn:hover:not(:disabled),
.light-mode .reset-terms-btn:focus:not(:disabled),
