...
<template>
  <el-card ref="configCardRef" class="config-page" shadow="never">
    ...
    <el-card class="search-card" shadow="never">
      <el-form :model="searchForm" label-width="120px" :inline="true">
        ...
        <el-form-item :label="$t('requestLogs.listenAddr')">
          <el-select
            v-model="searchForm.listenAddr"
            :placeholder="$t('requestLogs.all')"
            style="width: 200px"
            clearable
            filterable
          >
        ...
        <el-form-item :label="$t('requestLogs.upstream')">
          <el-input
            ...
            :placeholder="$t('requestLogs.fuzzyMatch')"
            style="width: 200px"
            clearable
          />
        </el-form-item>
        ...
        <el-form-item :label="$t('requestLogs.statusCode')">
          <el-input-number
            ...
            :min="0"
            :max="999"
            :placeholder="$t('requestLogs.allStatusCodes')"
            style="width: 150px"
          />
        </el-form-item>
    ...
    >
      ...
      <el-table-column
        prop="listenAddr"
        :label="$t('requestLogs.listenAddr')"
        width="120"
        sortable="custom"
      />
      <el-table-column
        prop="clientIP"
        :label="$t('requestLogs.clientIP')"
        width="130"
        sortable="custom"
      />
      <el-table-column
        prop="remoteIP"
        :label="$t('requestLogs.remoteIP')"
        width="130"
        sortable="custom"
      />
      <el-table-column
        prop="method"
        :label="$t('requestLogs.method')"
        width="80"
        sortable="custom"
      />
      <el-table-column
        prop="requestPath"
        :label="$t('requestLogs.requestPath')"
        min-width="200"
      ...
      <el-table-column
        prop="statusCode"
        :label="$t('requestLogs.statusCode')"
        width="100"
        sortable="custom"
      >
        <template #default="{ row }">
