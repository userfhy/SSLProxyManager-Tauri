    ...
    <div class="title-bar-drag-region" @dblclick="handleMaximize" @mousedown="handleStartDragging">
      ...
      <div class="title-bar-right">
        <div class="window-controls">
          <button class="window-control-btn minimize-btn" @click="handleMinimize" title="最小化">
          ...
          >
            <svg v-if="!isMaximized" width="12" height="12" viewBox="0 0 12 12">
              <path
                d="M 1 1 L 11 1 L 11 11 L 1 11 Z"
                stroke="currentColor"
                stroke-width="1.5"
                fill="none"
              />
            ...
            <svg v-else width="12" height="12" viewBox="0 0 12 12">
              <path
                d="M 2 4 L 10 4 L 10 10 L 2 10 Z"
                stroke="currentColor"
                stroke-width="1.5"
                fill="none"
              />
          ...
          <button class="window-control-btn close-btn" @click="handleClose" title="关闭">
            <svg width="12" height="12" viewBox="0 0 12 12">
              <path
