...
export type SaveDialogResult = string;
...
export async function SaveConfig<TConfig = unknown, TResult = TConfig>(
  config: TConfig,
): Promise<TResult> {
...
export async function AddBlacklistEntry<T = unknown>(
  ip: string,
  reason: string,
...
export async function SaveChartPngWithDialog(
...
export async function SetListenRuleEnabled<T = unknown>(
  listenRuleId: string,
  enabled: boolean,
): Promise<T> {
...
export async function SetRouteEnabled<T = unknown>(
  listenRuleId: string,
  routeId: string,
  enabled: boolean,
): Promise<T> {
...
export async function OpenChartPreviewWindow(
  title: string,
  payloadKey: string,
  windowKey?: string,
): Promise<void> {
...
export async function EventsOn<T = unknown>(
  event: string,
